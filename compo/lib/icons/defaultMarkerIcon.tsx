...
/* Aggregated Marker Icon */
export  const MarkerDefaultIcon = ({ height = "25px", width = "25px", fill = "#151515", className = "", children }: MarkerDefaultIconTypes): JSX.Element => {
    ...
    return (
        <div className='relative flex flex-col items-center justify-center '>
            ...
            <svg width={width} height={height} viewBox="0 0 24 30" className={className} >
                ...
                <rect x="2" y="2" width="38" height="20" fill="white" stroke={fill} strokeWidth="1" ry="10" rx="10" />
            </svg>
            </div>
    ...
    <g  stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" fillOpacity="1">
        <g  transform="translate(4.000000, -27.000000)" fill="black">
